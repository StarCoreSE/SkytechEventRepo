        ...
        internal class NetworkProfilePacket : PacketBase
        {
            ...
            public override void Received(ulong senderSteamId, bool fromServer)
            {
                if (MyAPIGateway.Session.IsServer)
                {
                    ...
                    MyVisualScriptLogicProvider.SendChatMessageColored($"Network profiling requested by \"{requesterName}\" for {_duration:N}s - performance may drop.", Color.Red, "SkyTech Engines");
